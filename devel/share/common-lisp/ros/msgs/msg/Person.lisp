...
(cl:defclass <Person> (roslisp-msg-protocol:ros-message)
  ((name
   ...
   (proxemic
    :reader proxemic
    :initarg :proxemic
    :type msgs-msg:Proxemic
    :initform (cl:make-instance 'msgs-msg:Proxemic)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs-msg:<Person> is deprecated: use msgs-msg:Person instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs-msg:name-val is deprecated.  Use msgs-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs-msg:pose-val is deprecated.  Use msgs-msg:pose instead.")
  (pose m))
...
(cl:defmethod reliability-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs-msg:reliability-val is deprecated.  Use msgs-msg:reliability instead.")
  (reliability m))

(cl:ensure-generic-function 'tagnames-val :lambda-list '(m))
(cl:defmethod tagnames-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs-msg:tagnames-val is deprecated.  Use msgs-msg:tagnames instead.")
  (tagnames m))

(cl:ensure-generic-function 'tags-val :lambda-list '(m))
(cl:defmethod tags-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs-msg:tags-val is deprecated.  Use msgs-msg:tags instead.")
  (tags m))

(cl:ensure-generic-function 'proxemic-val :lambda-list '(m))
(cl:defmethod proxemic-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs-msg:proxemic-val is deprecated.  Use msgs-msg:proxemic instead.")
  (proxemic m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Person>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'proxemic) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Person>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tags)))
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:aref vals i) __ros_str_idx) (cl:code-char (cl:read-byte istream))))))))
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'proxemic) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Person>)))
  ...
  "bf3f030e63b6c82a38e38bd3144e2e45")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Person)))
  "Returns md5sum for a message object of type 'Person"
  "bf3f030e63b6c82a38e38bd3144e2e45")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Person>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'proxemic))
))
