...
(cl:defmethod cl:initialize-instance :after ((m <Velocities>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Velocities)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nara_msgs-msg:<Velocities> is deprecated: use nara_msgs-msg:Velocities instead.")))

(cl:ensure-generic-function 'linear_x-val :lambda-list '(m))
(cl:defmethod linear_x-val ((m <Velocities>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nara_msgs-msg:linear_x-val is deprecated.  Use nara_msgs-msg:linear_x instead.")
  (linear_x m))

(cl:ensure-generic-function 'linear_y-val :lambda-list '(m))
(cl:defmethod linear_y-val ((m <Velocities>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nara_msgs-msg:linear_y-val is deprecated.  Use nara_msgs-msg:linear_y instead.")
  (linear_y m))

(cl:ensure-generic-function 'angular_z-val :lambda-list '(m))
(cl:defmethod angular_z-val ((m <Velocities>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nara_msgs-msg:angular_z-val is deprecated.  Use nara_msgs-msg:angular_z instead.")
  (angular_z m))
