...
(cl:defmethod cl:initialize-instance :after ((m <Imu>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Imu)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nara_msgs-msg:<Imu> is deprecated: use nara_msgs-msg:Imu instead.")))

(cl:ensure-generic-function 'linear_acceleration-val :lambda-list '(m))
(cl:defmethod linear_acceleration-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nara_msgs-msg:linear_acceleration-val is deprecated.  Use nara_msgs-msg:linear_acceleration instead.")
  (linear_acceleration m))

(cl:ensure-generic-function 'angular_velocity-val :lambda-list '(m))
(cl:defmethod angular_velocity-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nara_msgs-msg:angular_velocity-val is deprecated.  Use nara_msgs-msg:angular_velocity instead.")
  (angular_velocity m))

(cl:ensure-generic-function 'magnetic_field-val :lambda-list '(m))
(cl:defmethod magnetic_field-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nara_msgs-msg:magnetic_field-val is deprecated.  Use nara_msgs-msg:magnetic_field instead.")
  (magnetic_field m))
